...
def gateway(
    ...
    agent = AgentLoop(
        ...
        memory_consolidation_interval=config.agents.defaults.memory_consolidation_interval,
        memory_auto_update_long_term=config.agents.defaults.memory_auto_update_long_term,
